...
| Kruskal                             | 与えられた無向グラフの最小全域木を求める手法<br/>残っている辺の中からコストが最小の辺 e を取り出す。現在構成中の T に e を加えても閉路ができないなら T に加える。（[引用](https://algo-logic.info/kruskal-mst/)） |                   | [Aizu_GRL_2_A](https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_2_A&lang=ja) |
|                                     |                                                              |                   |                                                              |
